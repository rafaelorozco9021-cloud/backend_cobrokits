...
export class MonthlyReportController {
  ...
  async list(@Query('sellerId') sellerId?: string) {
    try {
      ...
      return { stub: true, module: 'monthly-report', table: 'daily_seller_stock', message: 'Tabla no inicializada o sin datos', error: (e as Error).message };
    }
  }

  @Post()
  async create(@Body() body: any) {
    return { stub: true, module: 'monthly-report', received: body, message: 'POST stub - implementar logica de negocio' };
  }

  @Patch()
  async update(@Body() body: any) {
    return { stub: true, module: 'monthly-report', received: body, message: 'PATCH stub' };
  }
